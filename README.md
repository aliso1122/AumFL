...
The top-layer parameters are defined in the file <font color=#008000 >control/Enums.py</font>, i.e. FLFramework, FLSubtype, LearningType and FLEnvironment. Browsing this file as the start can help you have a quick overview of the project.
